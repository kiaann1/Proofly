...
export default function CVBuilderPage() {
  ...
  const handleTabSwitch = (newTab: 'form' | 'preview' | 'ats') => {
    ...
    <AppLayout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-8 mb-8">
            ...
            <div className="border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-700/50">
              <nav className="flex px-6">
                {[
                  ...
                  <button
                    key={tab.id}
                    onClick={() => handleTabSwitch(tab.id as 'form' | 'preview' | 'ats')}
                  ...
                  >
                    ...
                    {/* Active indicator */}
                    {activeTab === tab.id && (
                      <div className="absolute inset-0 bg-blue-50/50 dark:bg-blue-900/20 rounded-t-lg -z-10"></div>
                    )}
                  </button>
                ))}
              </nav>
