    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-8 text-center">How It Works</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Upload Your CV</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Add Job Description</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Get Smart Analysis</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Instant Analysis</h3>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Actionable Tips</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
