        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pb-20 lg:pb-28">
          <div className="text-center">            {/* Badge */}
            <div className="flex justify-center items-center gap-4 mb-8">
              ...
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-100 text-green-800 text-sm font-bold border-2 border-green-200">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.293l-3-3a1 1 0 00-1.414-1.414L9 5.586 7.707 4.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4a1 1 0 00-1.414-1.414z" clipRule="evenodd" />
                </svg>
                100% FREE FOREVER
            ...
            <div className="bg-white/80 backdrop-blur rounded-2xl p-6 max-w-2xl mx-auto mb-12 border border-gray-200 shadow-lg">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">🎉 Everything is 100% Free - No Hidden Costs!</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <Link 
                href="/cover-letter" 
                className="group inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white text-lg font-semibold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
              >
                Create Cover Letter
                <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link 
                href="/ats" 
                className="group inline-flex items-center px-8 py-4 bg-white text-gray-900 text-lg font-semibold rounded-2xl hover:bg-gray-50 transition-all duration-300 shadow-lg border border-gray-200 hover:border-gray-300"
              >
                Analyse Existing CV
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group relative bg-gradient-to-br from-white to-blue-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Smart CV Builder</h3>
            ...
            {/* Feature 2 */}
            <div className="group relative bg-gradient-to-br from-white to-purple-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-200">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">ATS Optimisation</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            {/* Feature 3 */}
            <div className="group relative bg-gradient-to-br from-white to-green-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-green-200">
