...
export const getSkillCategoryColor = (category: string): string => {
  const colors: { [key: string]: string } = {
    ...
    'Frameworks & Libraries': 'bg-green-100 text-green-800',
    'Databases': 'bg-orange-100 text-orange-800',
    'Tools & Technologies': 'bg-purple-100 text-purple-800',
    'Cloud & DevOps': 'bg-indigo-100 text-indigo-800',
    'Design & UI/UX': 'bg-pink-100 text-pink-800',
    'Soft Skills': 'bg-gray-100 text-gray-800',
    'Languages': 'bg-red-100 text-red-800',
    'Marketing & Analytics': 'bg-yellow-100 text-yellow-800',
